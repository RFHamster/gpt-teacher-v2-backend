...
def send_chat_message(
	...
	message_crud.create_chat_message(
		session, agent_input.student_input, session_id
	)
	...
	ai_message = message_crud.create_chat_message(
		session, ai_message_in, session_id
	)
